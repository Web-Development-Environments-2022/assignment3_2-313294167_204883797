...
// /**
//  * This path gets body with recipe_id and save this recipe in the last viewed recipes of the logged-in user
//  */
...
router.get('/personal', async (req,res,next) => {
  try
  {
      ...
      res.status(204).send("There is no personal recipes");
    }
  } catch(error) {
      next(error); 
  }
